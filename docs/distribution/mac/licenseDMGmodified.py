...
def main(dmgFile, license):
            ...
            f.write("""resource 'STR#' (5002, "English") {
    {
        ...
        os.system('/Applications/Xcode.app/Contents/Developer/Tools/Rez /Developer/Headers/FlatCarbon/*.r %s -a -o "%s"' % (tmpFile, dmgFile))
...
if __name__ == '__main__':
    if len(sys.argv) != 3:
        printUsage()
    if not os.path.exists('/Applications/Xcode.app/Contents/Developer/Tools/Rez'):
        printUsage()
    main(*sys.argv[1:])
