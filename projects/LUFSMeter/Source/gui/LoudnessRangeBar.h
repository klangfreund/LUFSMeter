...
#ifndef __LOUDNESS_RANGE_BAR__
#define __LOUDNESS_RANGE_BAR__
...
*/
class LoudnessRangeBar  : public Component,
                          public Value::Listener
{
public:
    LoudnessRangeBar (const Value & startValueToReferTo,
